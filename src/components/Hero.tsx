            ...
            <Container>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-7 space-y-8">
                        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-100/50 border border-blue-200/50 text-blue-800 text-sm font-medium backdrop-blur-sm">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8 border-t border-slate-200/60">
                            <div>
                                <div className="text-3xl font-bold text-slate-800">{profile.stats.scopus_publications}</div>
                                <div className="text-sm text-slate-500">Scopus Pubs</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-slate-800">{profile.stats.scie_wos_publications}</div>
                                <div className="text-sm text-slate-500">SCIE/WoS Pubs</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-slate-800">{profile.stats.google_scholar_h_index}</div>
                                <div className="text-sm text-slate-500">H-Index</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-5 relative">
                        ...
                        <GlassCard className="relative p-3 rotate-2 hover:rotate-0 transition-transform duration-500">
